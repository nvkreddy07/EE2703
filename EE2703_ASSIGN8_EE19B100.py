...
#this is a function that converts a sympy function to a version that is understood by scipy.signals 
...
plotter(t,damped1(t),"High frequency damped sinusoid","t","V_i(t)")

#Plotting low damped sinusoid
t = np.linspace(0,0.5,1000000)
plotter(t,damped2(t),"Low frequency damped sinusoid","t","V_i(t)")
