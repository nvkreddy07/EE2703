import sys    #functions defined in sys module can be used

import numpy as np  #numpy can be called by using np
from numpy import cos,sin  # import cos and sin functions from module numpy
